...
namespace I3Lab.Treatments.Domain.Members
{
    public interface IMemberRepository
    {
        ...
        Task<Member> GetAsync(MemberId id, CancellationToken cancellationToken = default);
        ...
        Task DeleteByIdIfExistAsync(MemberId id, CancellationToken cancellationToken = default);
